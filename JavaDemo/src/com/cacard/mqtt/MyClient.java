...
public class MyClient {
	...
	public MyClient(String brokerUrl, String clientId, boolean cleanSession,
	...
	public void publish(String topicName, int qos, byte[] payload)
		...
		System.out.println("Connecting to " + brokerUrl + " with client ID "
				+ client.getClientId());
	...
	public void subscribe(String topicName, int qos) throws MqttException {
		...
		// Connect to the MQTT server
		client.connect(conOpt);
		System.out.println("Connected to " + brokerUrl + " with client ID "
				+ client.getClientId());
		...
		System.out.println("Subscribing to topic \"" + topicName + "\" qos "
				+ qos);
