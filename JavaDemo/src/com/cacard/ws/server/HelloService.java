 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://ws.cacard.com/", wsdlLocation = "http://localhost:8080/WS/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://ws.cacard.com/", "HelloService");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://ws.cacard.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.cacard.com/", "HelloPort"), Hello.class, features);
    }
